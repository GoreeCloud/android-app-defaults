...
**Lifecycle:** Development candidate on `feature/since-keyboard-focus-evidence`  
...
This is automated emulator keyboard evidence only. Representative physical-keyboard behavior, external switch-device acceptance, TalkBack/large-font visual acceptance, localization/RTL acceptance, GLAZE consumer acceptance, and M2–M6 remain open.
